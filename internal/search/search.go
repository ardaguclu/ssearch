...
func (s *S) Start(ctx context.Context, req *SReq) ([]s3.Object, error) {
	...
	err = c.ListObjectsV2PagesWithContext(ctx, loi,
		func(page *s3.ListObjectsV2Output, lastPage bool) bool {
			s := s.search(ctx, page.Contents, req.StartDate, req.EndDate)
			if s != nil {
...
func (s *S) search(ctx context.Context, contents []*s3.Object, sd, ed int64) []s3.Object {
	var res []s3.Object
...
// files.
func (s *S) found(ctx context.Context, key string) bool {
	/*downloader := s3manager.NewDownloader(s.sess, func(d *s3manager.Downloader) {
